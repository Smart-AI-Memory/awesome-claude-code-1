...
- [Attune AI](https://github.com/Smart-AI-Memory/attune-ai) by [Smart AI Memory](https://github.com/Smart-AI-Memory) - Developer workflow tools with security audits, code reviews, test generation, and release preparation via /attune command. Features cost-optimized model routing across Claude Haiku, Sonnet, and Opus, with 18 MCP tools, 7 skills, and 4 slash commands. Available on [PyPI](https://pypi.org/project/attune-ai/).
- [Book Factory](https://github.com/robertguss/claude-skills) by [Robert Guss](https://github.com/robertguss) - A comprehensive pipeline of Skills that replicates traditional publishing infrastructure for nonfiction book creation using specialized Claude skills.
